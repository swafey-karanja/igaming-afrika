...
const Navbar = () => {
  ...
  return (
    <header
      className={`fixed top-[50px] sm:top-[80px] md:top-[100px] max-w-[1300px] mx-auto px-6 lg:px-8 inset-x-0 z-40 py-2 sm:py-3 md:py-6 transition-all duration-700 ease-in-out ${
        isScrolled
