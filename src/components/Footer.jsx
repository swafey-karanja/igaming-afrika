  ...
  return (
    <footer className="bg-gray-100 text-gray-700 py-12">
      ...
      <motion.div 
        ...
        className="max-w-6xl mx-auto bg-gray-900 text-white py-20 rounded-lg px-6"
      >
      ...
      <motion.button
        ...
        className="fixed bottom-5 end-5 rounded-full bg-gray-600 p-3 text-xs font-medium uppercase leading-tight cursor-pointer text-white shadow-md hover:bg-gray-700 hover:shadow-lg focus:outline-none focus:ring-0"
      >
