...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-100 text-gray-700 py-8">
      ...
      {/* Links Section */}
      <div className="max-w-6xl mx-auto px-6 sm:px-6 lg:px-8 py-20">
      ...
      <button
        type="button"
        onClick={scrollToTop}
        className={`fixed bottom-5 end-5 rounded-full bg-gray-600 p-3 text-xs font-medium uppercase leading-tight cursor-pointer text-white shadow-md transition duration-150 ease-in-out hover:bg-gray-700 hover:shadow-lg focus:bg-gray-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg ${
