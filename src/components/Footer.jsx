    ...
    <footer className="bg-white text-gray-700">
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* COMPANY Column */}
          <div className="space-y-4">
            <h3 className="text-md font-bold text-green-600">COMPANY</h3>
          ...
          {/* HELP Column */}
          <div className="space-y-4">
            <h3 className="text-md font-bold text-green-600">HELP</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#" className="hover:text-green-600">
                  Customer Support
          ...
          {/* RESOURCES Column */}
          <div className="space-y-4">
            <h3 className="text-md font-bold text-green-600">RESOURCES</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#" className="hover:text-green-600">
                  Free eBooks
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-6 lg:px-8 py-10">
        <div className="flex items-center justify-center space-x-4 pt-2">
          <a href="#" className="text-green-400 hover:text-green-600">
            <svg
