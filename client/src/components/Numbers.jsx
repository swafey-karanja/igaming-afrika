    ...
    >
      ...
      <div className="w-full flex justify-center bg-gray-100/90">
        ...
        >
          <motion.div 
            variants={fadeIn}
            className="lg:w-1/2 items-center px-8 sm:px-4"
          >
          ...
          <motion.div 
            ...
            className="lg:w-2/4 px-8 sm:px-4"
          >
            <img 
      ...
      <motion.div 
        ...
        className="w-full max-w-7xl mx-auto px-4 py-8 md:py-12 lg:py-16 flex-1 flex flex-col justify-center"
      >
        <motion.h2 
          variants={fadeIn}
